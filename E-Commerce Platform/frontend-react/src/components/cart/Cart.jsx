            ...
            <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4">
                ...
                <div className="flex text-sm gap-1 flex-col">
                    <div className="flex justify-between w-full md:text-lg text-sm font-semibold">
                        <span>Subtotal</span>
                        <span className="text-shadow-amber-500">{formatPrice(newCart?.totalPrice)}</span>
                    </div>
                    ...
                    <button
                        onClick={() => {}}
                        className="font-semibold w-[300px] py-2 px-4 rounded-xs bg-blue-400 text-white flex items-center justify-center gap-2 hover:text-gray-300 transition duration-500">
