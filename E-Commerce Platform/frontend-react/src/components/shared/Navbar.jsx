...
const Navbar = () => {
    ...
    return (
        <div className="h-[70px] text-white z-50 flex items-center sticky top-0"
        style={{ backgroundImage: "linear-gradient(to right, #111827, #1f2937)" }}>
            ...
            style={!navbarOpen ? {} : { backgroundImage: "linear-gradient(to right, #111827, #1f2937)" }}>
            ...
            className="sm:hidden flext items sm:mt-0 mt-2">
                {navbarOpen ? (
